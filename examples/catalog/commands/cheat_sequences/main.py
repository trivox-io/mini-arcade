"""
Example: commands/cheat_sequences

Demonstrates CheatManager registering key sequences that trigger commands.
"""
...
EXAMPLE_ID = "commands/cheat_sequences"
DEFAULT_SCENE_ID = "cheat_sequences_demo"
DEFAULT_DISCOVER_PACKAGES = [
    "examples.catalog.commands.cheat_sequences",
...
def build_example(**kwargs) -> ExampleSpec:
    """Build tutorial spec for cheat sequences demo."""
