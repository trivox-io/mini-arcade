"""
Example: commands/scene_stack_commands

Demonstrates PushSceneCommand, PopSceneCommand, ChangeSceneCommand,
and PushSceneIfMissingCommand to drive scene navigation via commands.
"""
...
EXAMPLE_ID = "commands/scene_stack_commands"
DEFAULT_SCENE_ID = "stack_main"
DEFAULT_DISCOVER_PACKAGES = [
    "examples.catalog.commands.scene_stack_commands",
...
def build_example(**kwargs) -> ExampleSpec:
    """Build tutorial spec for scene stack commands demo."""
