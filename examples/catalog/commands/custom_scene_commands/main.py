"""
Example: commands/custom_scene_commands

Shows how to define and dispatch custom Command subclasses from systems.
"""
...
EXAMPLE_ID = "commands/custom_scene_commands"
DEFAULT_SCENE_ID = "custom_commands_demo"
DEFAULT_DISCOVER_PACKAGES = [
    "examples.catalog.commands.custom_scene_commands",
...
def build_example(**kwargs) -> ExampleSpec:
    """Build tutorial spec for custom scene commands demo."""
