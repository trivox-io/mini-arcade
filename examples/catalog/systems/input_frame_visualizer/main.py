"""
Example: systems/input_frame_visualizer

Displays live InputFrame state: keys held, pressed/released this frame,
mouse position, axes, and buttons.
"""
...
EXAMPLE_ID = "systems/input_frame_visualizer"
DEFAULT_SCENE_ID = "input_frame_visualizer"
DEFAULT_DISCOVER_PACKAGES = [
    "examples.catalog.systems.input_frame_visualizer",
...
def build_example(**kwargs) -> ExampleSpec:
    """Build tutorial spec for the InputFrame visualizer example."""
