"""
Example: systems/animation_tick_builtin

Shows AnimationTickSystem stepping entity animations each frame.
"""
...
EXAMPLE_ID = "systems/animation_tick_builtin"
DEFAULT_SCENE_ID = "animation_tick_demo"
DEFAULT_DISCOVER_PACKAGES = [
    "examples.catalog.systems.animation_tick_builtin",
...
def build_example(**kwargs) -> ExampleSpec:
    """Build tutorial spec for AnimationTickSystem demo."""
