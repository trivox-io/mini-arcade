"""
Example: systems/cull_viewport_builtin

Shows CullOutOfViewportSystem filtering entities that leave the viewport.
"""
...
EXAMPLE_ID = "systems/cull_viewport_builtin"
DEFAULT_SCENE_ID = "cull_viewport_demo"
DEFAULT_DISCOVER_PACKAGES = [
    "examples.catalog.systems.cull_viewport_builtin",
...
def build_example(**kwargs) -> ExampleSpec:
    """Build tutorial spec for CullOutOfViewportSystem demo."""
