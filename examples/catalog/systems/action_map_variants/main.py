"""
Example: systems/action_map_variants

Demonstrates ActionMap with digital and axis bindings, showing how
raw keys are converted to logical actions via ActionIntentSystem.
"""
...
EXAMPLE_ID = "systems/action_map_variants"
DEFAULT_SCENE_ID = "action_map_variants"
DEFAULT_DISCOVER_PACKAGES = [
    "examples.catalog.systems.action_map_variants",
...
def build_example(**kwargs) -> ExampleSpec:
    """Build tutorial spec for ActionMap variants example."""
