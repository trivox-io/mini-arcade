"""
Example: systems/pause_intent_builtin

Shows IntentPauseSystem converting an intent flag into a PushScene command.
"""
...
EXAMPLE_ID = "systems/pause_intent_builtin"
DEFAULT_SCENE_ID = "pause_intent_demo"
DEFAULT_DISCOVER_PACKAGES = [
    "examples.catalog.systems.pause_intent_builtin",
...
def build_example(**kwargs) -> ExampleSpec:
    """Build tutorial spec for IntentPauseSystem demo."""
