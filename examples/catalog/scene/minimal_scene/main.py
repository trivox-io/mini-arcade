...
EXAMPLE_ID = "scene/minimal_scene"
DEFAULT_SCENE_ID = "minimal_scene"
DEFAULT_DISCOVER_PACKAGES = [
    "examples.catalog.scene.minimal_scene",
...
def build_example(**kwargs) -> ExampleSpec:
    """
    Build tutorial spec for a minimal SimScene example.
    """
