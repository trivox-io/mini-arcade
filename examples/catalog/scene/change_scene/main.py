...
EXAMPLE_ID = "scene/change_scene"
DEFAULT_SCENE_ID = "change_scene_hub"
DEFAULT_DISCOVER_PACKAGES = [
    "examples.catalog.scene.change_scene",
...
def build_example(**kwargs) -> ExampleSpec:
    """
    Build tutorial spec for scene/change_scene.
    """
