"""
Example: scene/debug_overlay_builtin
"""
...
EXAMPLE_ID = "scene/debug_overlay_builtin"
DEFAULT_SCENE_ID = "debug_overlay_builtin"
...
def build_example(**kwargs) -> ExampleSpec:
    """
    Build tutorial spec for built-in debug overlay behavior.
    """
