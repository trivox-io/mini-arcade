"""
Example: scene/pause_overlay_policy
"""
...
EXAMPLE_ID = "scene/pause_overlay_policy"
DEFAULT_SCENE_ID = "pause_overlay_policy_play"
DEFAULT_DISCOVER_PACKAGES = [
    "examples.catalog.scene.pause_overlay_policy",
...
def build_example(**kwargs) -> ExampleSpec:
    """
    Build tutorial spec for scene/pause_overlay_policy.
    """
